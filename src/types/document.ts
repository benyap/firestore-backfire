...
// HACK: These imports are only used in JSDoc strings, so the
// compiler complains that they're not "used". This hack "uses"
// the imports to silence the compiler warning.
{
  const _:
    | Timestamp
    | GeoPoint
